                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <div tabindex="-1" class="dropdown-divider"></div>
                                           <a href="login.jsp"> <button type="button" tabindex="0" class="dropdown-item">Log Out</button></a>
                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <p style="color:#000; margin:10px" class="panel-money__title">Account Holders List <button type="submit" id ="accountlist" onclick="AccountsList();this.disabled=true;">View</button></p>	
                                        ...
                                        <tbody id="myTable">
														...
														<td> </td>
														<td  id="details">
																		<select class="cards__settings-field cards__select Action" id="detail" data-placeholder="Action">
																			<option value="Item"></option>
																			<option name="balance" id="Balance"  value="balance">Balance</option>
																			<option name="status" id="status" value="Status">Status</option>
																		</select>
														</td>
											</table> -->
										</tbody>
