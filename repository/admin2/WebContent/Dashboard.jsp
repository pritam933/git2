                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        ...
                                        <div tabindex="-1" role="menu" aria-hidden="true" class="dropdown-menu dropdown-menu-right">
                                            <button type="button" tabindex="0" class="dropdown-item">Edit Account</button>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-midnight-bloom">
                                    <div class="widget-content-wrapper text-white">
                                        <div class="widget-content-left">
                                            <div class="widget-heading">Total card Holders</div>
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="card mb-3 widget-content bg-arielle-smile">
                                    <div class="widget-content-wrapper text-white">
                                        ...
                                        <div class="widget-content-right">
                                            <div class="widget-numbers text-white"><span>$ 100000</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <li class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            <div class="widget-heading">Mithilesh Kumar</div>
                                                                            <div class="widget-subheading">Backend Developer</div>
                                                                        </div>
                                                                        <div class="widget-content-right">
                                                            ...
                                                            <li class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            <div class="widget-heading"> ShashiKant Kumar</div>
                                                            ...
                                                            <li class="list-group-item">
                                                                <div class="widget-content p-0">
                                                                    <div class="widget-content-wrapper">
                                                                        ...
                                                                        <div class="widget-content-left">
                                                                            <div class="widget-heading">Deepak Choudhary</div>
                                                                            <div class="widget-subheading">Client Relation Manager</div>
                                                                        </div>
                                                                        <div class="widget-content-right">
                                                                            <div class="font-size-xlg text-muted">
                                                                                <small class="opacity-5 pr-1">$</small>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Master Account
                                        <div class="btn-actions-pane-right">
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            <div class="widget-content-left mr-3">
                                                                <div class="widget-content-left">
                                                                    <img width="40" class="rounded-circle" src="assets/images/avatars/99.jpg" alt="">
                                                                </div>
                                                            </div>
                                                            <div class="widget-content-left flex2">

                                                                
                                                                <div class="widget-heading">Sanjit Ghanti</div>
                                                                <div class="widget-subheading opacity-7">StyloPay</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">42158</td>
                                                <td class="text-center">
                                                    <div class="badge badge-warning">Pending</div>
                                                </td>
                                                <td class="text-center">RSI</td>
                                              
                                                <td class="text-center">949596626</td>
                                                ...
                                                <td>
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left flex2">
                                                                <div class="widget-heading">Avishek Singh</div>
                                                                <div class="widget-subheading opacity-7">StyloPay</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="text-center">42548</td>
                                                <td class="text-center">
                                                    <div class="badge badge-success">Completed</div>
                                                </td>
                                                <td class="text-center">RSI</td>
                                                <td class="text-center">974161646131</td>
                                                <td class="text-center">yes</td>
                                                <td class="text-center">
                                                    <div class="mb-2 mr-2 dropleft btn-group">
                                                        <button class="btn-wide btn btn-primary">Details</button>
