...
public class CardStatus {
	...
	public String clxCardStatusAPI(String userId, String accountId) throws JSONException{
		...
		try {
			...
			URL url = new URL("http://35.180.75.185/StyloDemoApiServer/API/Card/Status");
			...
			System.out.println("CardStatus API Json input is: " + input);
